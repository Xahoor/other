                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="gandhara-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                          ...
                          <li><a href="student/login.php" class="nav-item">Log In</a></li>
                          <li>
    ...
    <div class="carousel-inner">
        <div class="item active">
            ...
            <div class="carousel-caption">
                <a href="#ABOUT"><h3 class="index-carousel-title"><blink>Why LearnCS?</blink></h3></a>
        ...
        <div class="item">
            ...
            <div class="carousel-caption">
                <a href="#COURSES"><h3 class="index-carousel-title"><blink>Our Product?</blink></h3></a>
        ...
        <div class="item">
			...
			<div class="carousel-caption">
                <a href="#CONTACT"><h3 class="index-carousel-title"><blink>How to Contact Us?</blink></h3></a>
		 ...
		 <div class="item">
           ...
           <div class="carousel-caption">
                <a href="student/signup.php"><h3 class="index-carousel-title"><blink>Sign Up?</blink></h3></a>
	...
	<!-- Start: Welcome Section -->
        ...
        <div class="about-us-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="about-side wow slideInLeft" 
