			...
			<div class="row">
				...
				<script>					
					...
					<h1> <?php 
						...
						$q = "select std_name from student_tbl where std_email = '$std_email'";
			...
			<div class="row">
				...
				<div class="col-md-offset-3 col-md-8 section-context">
					<div class="row">
						...
						<?php 
							$std_email_pic = $_SESSION['student_user_name'];
					
							$q_pic = "select * from student_tbl where std_email = '$std_email'";
