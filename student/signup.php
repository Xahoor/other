...
<body>
	...
	<hr>
	 ...
	 <?php
			...
			if(isset($_POST["user_submit_btn"])){
				...
				$std_info_dob =$_POST["user_ac_dob"];
				$check = "select * from student_tbl where std_email='$std_info_email'";
  ...
  type: "warning",
				...
				$q = "insert into student_tbl(std_name,std_email,std_password,std_DOB,std_contact) values('$std_info_name','$std_info_email','$std_info_pass','$std_info_dob','$std_info_contact')";
